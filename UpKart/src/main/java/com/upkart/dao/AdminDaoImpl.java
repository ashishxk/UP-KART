...
public class AdminDaoImpl implements IAdminDao {
	...
	public void deleteProduct(int productId) {
		...
		try {
			PreparedStatement statement = connection.prepareStatement(Queries.DELETEALLQUERY);
	...
	public List<Admin> getProductsInfo() {
		...
		try {
			PreparedStatement statement = connection.prepareStatement(Queries.SHOWPRODUCTSQUERY);
