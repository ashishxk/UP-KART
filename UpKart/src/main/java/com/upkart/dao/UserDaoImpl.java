...
public class UserDaoImpl implements IUserDao {
	...
	public String deleteAccount(String userName) {
		...
		try {
			statement = connection.prepareStatement(Queries.DELETEACCOUNTQUERY);
			statement.setString(1, userName);
			statement.execute();
	...
	public void addToCart(User userCart) {
		...
		try {
			...
			statement.setString(1, userCart.getUserName());
			statement.setString(2, userCart.getCategory());
			statement.setString(3, userCart.getBrand());
			statement.setString(4, userCart.getProductName());
			statement.setString(5, userCart.getPaymentOption());
			statement.setInt(6, userCart.getItemStock());
			statement.execute();
	 ...
	 * @return
	 */
	public List<User> viewCartItems(String userName) {
		Connection connection = DbConnection.openConnection();
